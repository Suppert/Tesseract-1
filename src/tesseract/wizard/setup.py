...
if exists:
    ...
    license = input("Do you accept the license? [Y/n]: ")
    ...
    if accept == False:
        ...
        name = input("Please select a name for your Tesseract server: ")
        Server.setName(name)
        port = input("Please select the port you would like your Tesseract server to run on: ")
        Server.setPort(port)
